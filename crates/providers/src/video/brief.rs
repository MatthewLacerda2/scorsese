...
impl Brief {
    ...
    /// recorded `path`, which after an edit still points at the previous
    /// generation. Every decision about whether a run has work goes through
    /// here so it cannot be made both ways.
